    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"> WebFarm </a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;">Monitoring</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/logopeternakan.jpg" class="user-image img-responsive"/>
					</li>
				
					 
                    <li><a href="index.php"><i class="fa fa-dashboard fa-3x"></i> Dashboard </a></li>
                    <li><a href="index.php?halaman=karyawan"><i class="fa fa-table fa-3x"></i> Data Karyawan</a></li>
                    <li><a href="index.php?halaman=logout"><i class="fa fa-square-o fa-3x"></i> Logout</a></li>
                </ul>
